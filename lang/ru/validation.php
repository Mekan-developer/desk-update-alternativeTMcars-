...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'Указанное значение :attribute встречается в утечках данных. Пожалуйста, выберите другое значение.',
    ],
    ...
    'custom' => [
        'phone' => [
            'regex' => 'Номер телефона должен быть в формате +993 и 8 цифр.',
        ],
    ],
    ...
    'attributes' => [
        ...
        'name_ru' => 'название (RU)',
        'name_tk' => 'название (TK)',
        'listings_limit' => 'лимит объявлений',
        'videos_limit' => 'лимит видео',
        'boost_limit' => 'лимит поднятий',
        'duration_days' => 'срок действия (дней)',
        'reason' => 'причина',
        'rejection_reason_id' => 'причина отклонения',
        'complaint_reason_id' => 'причина жалобы',
        'code' => 'код',
        'password' => 'пароль',
        'email' => 'email',
    ],
